...
export interface ApiPlataformaPlataforma extends Schema.CollectionType {
  ...
  attributes: {
    nomePlataforma: Attribute.String;
    logoPlataforma: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
export interface ApiSerieSerie extends Schema.CollectionType {
  ...
  attributes: {
    ...
    FaixaEtaria: Attribute.Integer;
    Genero: Attribute.String;
    CapaSerie: Attribute.Media;
    Descricao: Attribute.Text;
    Idioma: Attribute.String;
    Avaliacao: Attribute.Integer;
    PalavrasChave: Attribute.Text;
    OndeAssistir: Attribute.String;
    Imagens: Attribute.Media;
    ElencoImagem: Attribute.Media;
    ElencoNomeReal: Attribute.String;
    ElencoNomePersonagem: Attribute.String;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
